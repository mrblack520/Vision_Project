...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <!-- comingsoon-section -->
        <section class="comingsoon-section centred">
            <div class="bg-layer" style="background-image: url(assets/images/background/comingsoon-bg.jpg);"></div>
            <div class="large-container">
                <div class="inner-box">
                    ...
                    <h2>Coming Soon</h2>
                    <div class="timer p_relative d_block">
                        <div class="cs-countdown" data-countdown="01/24/2024 05:06:59"></div>
                    </div>
