    ...
    @include('components.loader')
        ...
        <section class="banner-section centred">
            ...
            <div class="banner-carousel owl-carousel owl-theme owl-dots-none" id="sync1">
            ...
            <ul class="social-links clearfix">
                <li><a href="/"><span class="fab fa-twitter"></span></li>
        ...
        <section class="about-section">
            <div class="shape-layer float-bob-y" style="background-image: url(assets/images/shape/shape-2.png);"></div>
            <div class="line-shape">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <div data-animation-box class="image-box p_relative d_block">
                            ...
                            <div class="text-inner">
                                ...
                                <a href="/modal17">see the modal</a>
                                <p>Karachi, Pakistan</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="content-box p_relative mr_50">
                            ...
                            <div class="author-box p_relative d_block">
                                ...
                                <div class="inner">
                                    ...
                                    <div class="designation">CEO - <span>Sanaullah</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="single-item-carousel owl-carousel owl-theme owl-nav-none">
                    ...
                    <div class="inner-box" style="background-image: url(assets/images/background/video-bg.jpg);">
                        <div class="content-box">
                            ...
                            <div class="video-btn">
                                <a href="https://youtu.be/xmfMTEFmqrs?si=-vsxNK8gkCXpn4Hk" class="lightbox-image" data-caption=""><i class="fa-solid fa-play"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="inner-box" style="background-image: url(assets/images/background/video-bg.jpg);">
                        <div class="content-box">
                            ...
                            <div class="video-btn">
                                <a href="https://youtu.be/pdxKoqWO-1M?si=pb-FNeg8HAflw7du" class="lightbox-image" data-caption=""><i class="fa-solid fa-play"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="inner-box" style="background-image: url(assets/images/background/video-bg.jpg);">
                        <div class="content-box">
                            ...
                            <div class="video-btn">
                                <a href="https://youtu.be/6JTs2YMHUjE?si=-M_jAWqMdZKZOxE8" class="lightbox-image" data-caption=""><i class="fa-solid fa-play"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- <!-- <section class="project-section"> -->
            ...
            <div class="large-container">
                ...
                <div class="more-btn centred">
                    <a href="project" class="theme-btn btn-one">View All Pojects</a>
                </div>
            </div>
        </section>
        <!-- project-section end -->
                            ...
                            <div class="inner-box">
                                <div class="content-box">
                                    <ul class="post-info clearfix">
                                        <li><i class="fa-solid fa-user"></i><a href="blog-details">Author &nbsp,</a></li>
                                        <li>12/12/2022</li>
                                    </ul>
                                    <h3><a href="blog-details">A Brief History on the Beginnings of Perfect View</a></h3>
                        ...
                        <div class="news-block-one">
                            <div class="inner-box">
                                <div class="content-box">
                                    ...
                                    <h3><a href="blog-details">A Brief History on the Beginnings of Perfect View</h3>
                                    <p>To be the priority for our clients and associates in their quest of finding, buying, selling, and renting.</p>
                                </div>
                                <div class="overlay-content">
                                    <div class="overlay-inner">
