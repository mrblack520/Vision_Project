            ...
            <div class="xs-sidebar-widget">
                <div class="sidebar-widget-container">
                    <div class="widget-heading">
                        <a href="./c" class="close-side-widget"><i class="fa-solid fa-xmark"></i></a>
                    </div>
                    <div class="sidebar-textwidget">
                        <div class="sidebar-info-contents">
                            <div class="content-inner">
                                ...
                                <ul class="social-box">
                                    <li class="facebook"><a href="./c" class="fab fa-facebook-f"></a></li>
                                    <li class="twitter"><a href="./c" class="fab fa-twitter"></a></li>
                                    <li class="linkedin"><a href="./c" class="fab fa-linkedin-in"></a></li>
                                    <li class="instagram"><a href="./c" class="fab fa-instagram"></a></li>
                                    <li class="youtube"><a href="./c" class="fab fa-youtube"></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
